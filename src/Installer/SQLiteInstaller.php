...
// Mark this as a SQLite database drop-in
define( 'SQLITE_DB_DROPIN_VERSION', 'PestWP' );

// Define SQLite database directory
if ( ! defined( 'FQDBDIR' ) ) {
    define( 'FQDBDIR', '{$databaseDir}/' );
}
...
require_once '{$pluginPath}/wp-includes/sqlite/db.php';
PHP;
    }
